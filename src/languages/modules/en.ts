...
export default {
  ...
  router: {
    ...
    studentRecordStatistic: "studentRecordStatistic",
    studentRecordProfile: "studentRecordProfile",
    studentRecordRealisticRecord: "studentRecordRealisticRecord",
    studentRecordRealisticRecordDetail: "studentRecordRealisticRecordDetail",
    studentRecordPortfolio: "studentRecordPortfolio",
    studentRecordPortfolioDetail: "studentRecordPortfolioDetail",
    studentRecordPortfolioRecordDetail: "studentRecordPortfolioRecordDetail",
    activity: "activity",
    activityReportPeriod: "activityReportPeriod",
    program: "program",
    programActivity: "programActivity",
    programActivityDetail: "programActivityDetail",
    programRecord: "programRecord",
    programRecordDetail: "programRecordDetail",
    programCatalog: "programCatalog",
    questionnaire: "questionnaire",
    questionnaireRecord: "questionnaireRecord",
    questionnaireRecordDetail: "questionnaireRecordDetail",
    questionnaireRespondent: "questionnaireRespondent",
    questionnaireRespondentDetail: "questionnaireRespondentDetail",
    framework: "framework",
    frameworkDimension: "frameworkDimension",
    frameworkDimensionDetail: "frameworkDimensionDetail",
    frameworkStudentBaseIndex: "frameworkStudentBaseIndex",
    frameworkStudentBaseIndexDetail: "frameworkStudentBaseIndexDetail",
    card: "card",
    cardRecord: "cardRecord",
    cardRecordDetail: "cardRecordDetail",
    cardBatch: "cardBatch",
    cardBatchDetail: "cardBatchDetail",
    ...
    systemDic: "systemDic",
    systemReportPeriod: "systemReportPeriod",
    systemAppOperator: "systemAppOperator",
