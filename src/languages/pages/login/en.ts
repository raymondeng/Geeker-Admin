...
export default {
  ...
  mobile: {
    ...
    mobileErrorText: "mobile phone number error, please re-input",
    codeErrorText: "verification code error, please re-input"
  },
  scan: {
    text: "Open the mobile phone to scan and quickly log in / register"
  },
  missParamSchoolId: "Miss Parameter schoolId",
