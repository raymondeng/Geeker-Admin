...
export default {
  ...
  router: {
    home: "首頁",
    studentRecord: "學生記錄",
    studentRecordStatistic: "統計數據",
    studentRecordProfile: "學生主頁",
    studentRecordRealisticRecord: "寫實記錄",
    studentRecordRealisticRecordDetail: "寫實記錄詳情",
    studentRecordPortfolio: "檔案袋",
    studentRecordPortfolioDetail: "檔案袋詳情",
    studentRecordPortfolioRecordDetail: "檔案袋记录詳情",
    activity: "活動管理",
    activityReportPeriod: "報表配置",
    program: "項目管理",
    programActivity: "活動清單",
    programActivityDetail: "活動詳情",
    programRecord: "項目清單",
    programRecordDetail: "項目詳情",
    programCatalog: "項目類別清單",
    questionnaire: "問卷管理",
    questionnaireRecord: "問卷清單",
    questionnaireRecordDetail: "問卷詳情",
    questionnaireRespondent: "答卷清單",
    questionnaireRespondentDetail: "答卷詳情",
    framework: "體系管理",
    frameworkDimension: "維度管理",
    frameworkDimensionDetail: "維度詳情",
    frameworkStudentBaseIndex: "基礎指標管理",
    frameworkStudentBaseIndexDetail: "基礎指標詳情",
    card: "評價卡管理",
    cardRecord: "評價卡清單",
    cardRecordDetail: "評價卡詳情",
    cardBatch: "評價卡批次",
    cardBatchDetail: "評價卡批次詳情",
    cardCatalog: "評價卡类别",
    system: "系統設置",
    systemMenu: "選單管理",
    systemRole: "角色管理",
    ...
    systemDept: "部門管理",
    systemDic: "字典管理",
    systemReportPeriod: "報表配置",
    systemAppOperator: "運營人員管理",
    systemAppConfig: "參數管理",
    limits: "許可權管理",
    limitsFrontEnd: "前端控制",
