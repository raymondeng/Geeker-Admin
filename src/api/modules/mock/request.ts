...
import { MockResultData } from "@/api/interface/mock";
...
class RequestHttp {
   ...
   */
  get<T>(url: string, params?: object, _object = {}): Promise<MockResultData<T>> {
    return this.service.get(url, { params, ..._object });
  }
  post<T>(url: string, data?: object | string, _object = {}): Promise<MockResultData<T>> {
    return this.service.post(url, data, _object);
  }
  put<T>(url: string, data?: object, _object = {}): Promise<MockResultData<T>> {
    return this.service.put(url, data, _object);
  }
  delete<T>(url: string, params?: any, _object = {}): Promise<MockResultData<T>> {
